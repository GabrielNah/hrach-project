        ...
        <nav class="navbar d-none d-md-flex p-md-0 navbar-expand-sm navbar-light border-bottom">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTop4">
                    ...
                    <ul class="navbar-nav">
                        <li><a href="#" class="nav-link"> <img src="images/icons/flags/US.webp" height="16"> Ship to </a></li>
            ...
            <div id="carousel1_indicator" class="slider-home-banner carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/images/banners/slide2.webp" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img src="/images/banners/slide1.webp" alt="Second slide">
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <section class="padding-bottom">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-6">
                    <div class="card card-product-grid">
                        <a href="#" class="img-wrap"> <img src="images/items/8.webp"> </a>
                        <figcaption class="info-wrap">
                            <ul class="rating-stars mb-1">
                                <li style="width:80%" class="stars-active">
                                    <img src="images/icons/stars-active.svg" alt="">
            ...
            <div class="row">
                <aside class="col-md-6">
                    <div class="card card-banner-lg bg-dark">
                        <img src="images/banners/banner9.webp" class="card-img opacity">
                ...
                <div class="col-md-6">
                    <div class="card card-banner-lg bg-dark">
                        <img src="images/banners/slide1.webp" class="card-img opacity">
                        <div class="card-img-overlay text-white">
